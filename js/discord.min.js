        ...
        render: function() {
            ...
            function d() {
                ...
                function j(y, n) {
                    ...
                    $(z).attr("version", a);
                    var A = '<ul class="discord-tree"></ul><div class="split-in-2"><div class="imgboxlogo"><img src="assets/discord.png"></div><p class="discord-users-online"></p></div><div class="bgdiscord"><img src="assets/discord_bg.png" width="50"></div><p class="discord-join"></p><div class="discord-fade"></div>';
                    var u = "";
                    var r = "";
                    var l, w, x;
                    var v, m, q, o;
                    ...
                    if (y.instant_invite != "null") {
                        B = '<img src=assets/handleft.gif width="25"><a href="' + y.instant_invite + '" target="_blank"> Join Server </a><img src=assets/handright.gif width="25">'
                    }
                    l.innerHTML = u;
                    w.innerHTML = y.members.length;
                    if (n.join) {
                        x.innerHTML = B
                    } else {
